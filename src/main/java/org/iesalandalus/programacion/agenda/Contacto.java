...
public class Contacto {
	...
	/**
	 * 1. Creamos instancia de la clase StrinBuilder y le asignamos el nombre que al
	 * cual eleminamos espacios delante y detras por se a caso y convertimos todas
	 * las letras a las mayusculas 2. comprobamos el caracter, si es espacio en
	 * blanco, lo eleminamos y decimos que letra de la siguiente palabra va ser
	 * primera en otro caso comprobamos si es la primera letra, decimos que ya la
	 * hemos pasado y guardamos la aumentando el indiceToDelete si no es primera
	 * palabra, borramos este caracter.
	 * 
	...
	/**
	 * tenemos en cuenta solo los nombres ingnorando case.
	 */
	@Override
